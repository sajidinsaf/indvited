...
public class QueryMemberIdByEmailAndMemberTypeTest {

  private Query<MemberLoginBindingModel, Integer> queryMemberIdByEmailAndMemberType;
  ...
  public void setUp() {
    ...
    queryMemberIdByEmailAndMemberType = appContext.getBean("queryMemberIdByEmailAndMemberType", Query.class);
...
//    jdbcTemplate.execute("drop table member");
  ...
  public void shouldFindMemberId() {
    ...
    int memberId = queryMemberIdByEmailAndMemberType.data(loginModel);
    assertThat(memberId, Matchers.is(0));
