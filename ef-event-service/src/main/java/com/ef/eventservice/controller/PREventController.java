...
public class PREventController {
  ...
  private final @Qualifier("insertPREvent") Insert<PREventBindingModel, PREvent> eventPersistor;

  @Autowired
  public PREventController(@Qualifier("insertPREvent") Insert<PREventBindingModel, PREvent> eventPersistor) {
