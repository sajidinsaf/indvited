...
public class DbTestUtils {
  ...
  public EmbeddedDatabaseBuilder addCreateScripts(EmbeddedDatabaseBuilder embeddedDatabaseBuilder) {
    embeddedDatabaseBuilder.addScript("classpath:com/ef/dataaccess/member/createMemberLoginControlTable.sql")
        ...
        .addScript("classpath:com/ef/dataaccess/member/group/createMyGroupTypeTable.sql")
        .addScript("classpath:com/ef/dataaccess/member/group/createMyGroupTable.sql")
        .addScript("classpath:com/ef/dataaccess/member/group/createMyGroupMemberTable.sql")
        ...
        .addScript(
            "classpath:com/ef/dataaccess/event/schedule/subscription/web/createEventScheduleSubscriptionWeb.sql");
