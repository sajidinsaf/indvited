...
public class QueryMemberByEmail implements Query<String, Member> {
  ...
  private final String SELECT_MEMBER = "select id, firstname, lastname, email, gender, phone, date_registered, timestamp_of_last_login, is_enabled from member where email=?";
