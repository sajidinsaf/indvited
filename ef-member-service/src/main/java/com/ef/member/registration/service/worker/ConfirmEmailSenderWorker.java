...
public class ConfirmEmailSenderWorker
  ...
  private final Logger logger = LoggerFactory.getLogger(ConfirmEmailSenderWorker.class);
  private final String senderEmailAddress;
  private Session session;

  public ConfirmEmailSenderWorker(EmailSender<MimeMessage, String> mailSender, Session session,
