...
public class EventControllerConstants {
  ...
  public static final String CREATE_SCHEDULE_NOW = "/rest/event/createSchedule/now";

  public static final String CREATE_SCHEDULE_LATER = "/rest/event/createSchedule/later";
